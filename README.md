...
3. <a href="#elastic-compute-cloud-ec2">Elastic Compute Cloud (EC2)</a>

4. <a href="#lambda">Lambda</a>

5. <a href="#elasticbeanstalk">ElasticBeanstalk</a>

6. <a href="#auto-scaling">Auto Scaling</a>

7. <a href="#elastic-load-balancers-elb">Elastic Load Balancers (ELB)</a>

8. <a href="#storage-services">Storage Services</a>

9. <a href="#simple-storage-service-s3">Simple Storage Service (S3)</a>

10. <a href="#elastic-block-store-ebs">Elastic Block Store (EBS)</a>

11. <a href="#elastic-file-system-efs">Elastic File System (EFS)</a>

12. <a href="#amazon-fsx-for-windows">Amazon FSx for Windows</a>

13. <a href="#amazon-fsx-for-lustre">Amazon FSx for Lustre</a>

14. <a href="#storage-gateway">Storage Gateway</a>

15. <a href="#snowball">Snowball</a>
...
22. <a href="#network-services">Network Services</a>

23. <a href="#virtual-private-cloud-vpc">Virtual Private Cloud (VPC)</a>

24. <a href="#elastic-network-interfaces-eni">Elastic Network Interfaces (ENI)</a>

25. <a href="#route53">Route53</a>

26. <a href="#api-gateway">API Gateway</a>

27. <a href="#kinesis">Kinesis</a>

28. <a href="#identity-access-management-iam">Identity Access Management (IAM)</a>

29. <a href="#security-groups">Security Groups</a>

30. <a href="#cloudfront">CloudFront</a>

31. <a href="#web-application-firewall-waf">Web Application Firewall (WAF)</a>

32. <a href="#simple-queuing-service-sqs">Simple Queuing Service (SQS)</a>

33. <a href="#simple-notification-service-sns">Simple Notification Service (SNS)</a>

34. <a href="#simple-workflow-service-swf">Simple Workflow Service (SWF)</a>

35. <a href="#step-functions">Step Functions</a>

36. <a href="#cloudwatch">CloudWatch</a>

37. <a href="#cloudtrail">CloudTrail</a>

38. <a href="#cloudformation">CloudFormation </a>

39. <a href="#aws-organizations">AWS Organizations</a>

40. <a href="#miscellaneous">Miscellaneous</a>
...
- There are three different types of Kinesis:
  - Kinesis Data Streams
    - Kinesis Data Streams works where the data producers stream their data into Kinesis Data Streams which can retain the data from one day up until 7 days. Once inside 
      Kinesis Data Streams, the data is contained within shards.
  ...
  - Kinesis Data Firehose
    - Amazon Kinesis Data Firehose is the easiest way to load streaming data into data stores and analytics tools. When data is streamed into Kinesis Data Firehose, there is no persistent storage there to hold onto it. The data has to be analyzed as it comes in so it's optional to have Lambda functions inside your Kinesis Data Firehose. Once processed, you send the data elsewhere.
    - Kinesis Data Firehose can capture, transform, and load streaming data into Amazon S3, Amazon Redshift, Amazon Elasticsearch Service, and Splunk, enabling near real-time analytics with existing business intelligence tools and dashboards you’re already using today.
      
  - Kinesis Data Analytics
    - Kinesis Data Analytics works with both Kinesis Data Streams and Kinesis Data Firehose and can analyze data on the fly. The data within Kinesis Data Analytics also gets sent elsewhere once it is finished processing. It analyzes your data inside of the Kinesis service itself.
...
- Consumers, or the EC2 instances that read from Kinesis Data Streams, can go inside the shards to analyze what is in there. Once finished analyzing or parsing the data, the consumers can then pass on the data to a number of places for storage like a DB or S3.
- The total capacity of a Kinesis Data stream is the sum of data within its constituent shards.
